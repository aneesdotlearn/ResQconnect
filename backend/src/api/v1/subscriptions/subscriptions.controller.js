...
const PLANS = {
  basic: { price: 19900, currency: 'INR', interval: 'month', name: 'ResQconnect Basic' },
  premium: { price: 49900, currency: 'INR', interval: 'month', name: 'ResQconnect Premium' },
  enterprise: { price: 99900, currency: 'INR', interval: 'month', name: 'ResQconnect Enterprise' },
};
...
exports.generateInvoice = async (req, res, next) => {
  ...
  doc.fontSize(24).fillColor('#F20C63').text('ResQconnect', 50, 50);
  doc.fontSize(10).fillColor('#666').text('Women Safety & Emergency Response Platform', 50, 80);
