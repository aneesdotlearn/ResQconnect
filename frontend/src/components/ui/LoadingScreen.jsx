...
export default function LoadingScreen() {
  return (
    <div className="fixed inset-0 bg-base flex flex-col items-center justify-center gap-5 z-50">
      <div className="relative">
        ...
        <div className="absolute -inset-2 border-4 border-primary-100 rounded-3xl animate-ping" />
      </div>
      ...
      <div className="flex gap-1.5">
        {[0, 1, 2].map((i) => (
          <div
            key={i}
            className="w-2 h-2 bg-danger-500 rounded-full animate-bounce"
